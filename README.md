...
| `packages/quality` | G2.8 license whitelist, G1.5 coverage, G1.10 skip/empty-test detection, G1.8 Gitleaks, G1.6 oasdiff, G2.4 Semgrep + CodeQL, G2.5 Trivy, G2.3 Playwright |
