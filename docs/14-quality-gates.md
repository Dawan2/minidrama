...
**2026-08-28 (W20 QA-010 remainder, search).** The scan now requires search (`#/search`, SCR-03's search half) next to SCR-02, SCR-03, SCR-04, SCR-05, SCR-06, SCR-07, SCR-08, and SCR-13. Deleting any of the nine stems is red. Remaining implemented SCR/PNL fixtures are later remainders. Host is still jsdom, not TikTok WebView. This still does **not** close protocol-C4 exit 3 / S-A1 on every screen.

**2026-08-28 (W20 QA-010 remainder, SCR-09).** The scan now requires SCR-09 (wallet / `#/wallet`) next to SCR-02, SCR-03, SCR-04, SCR-05, SCR-06, SCR-07, SCR-08, search, and SCR-13. Deleting any of the ten stems is red. History and search landed on `main` while this slot wrote and are absorbed, not retaken. Remaining implemented SCR/PNL fixtures are later remainders. Host is still jsdom, not TikTok WebView. This still does **not** close protocol-C4 exit 3 / S-A1 on every screen.

**2026-08-28 (W21 QA-010 remainder, SCR-12).** The scan now requires SCR-12 (settings / `#/settings`) next to SCR-02, SCR-03, SCR-04, SCR-05, SCR-06, SCR-07, SCR-08, SCR-09, search, and SCR-13. Deleting any of the eleven stems is red. Wallet landed on `main` while this slot wrote and is absorbed, not retaken. Remaining implemented SCR/PNL fixtures (panels) are later remainders. Host is still jsdom, not TikTok WebView. This still does **not** close protocol-C4 exit 3 / S-A1 on every screen.

**2026-08-28 (W21 G2.3 remainder, E-20 analog).** `pnpm check:smoke` now requires `unlock-panel` next to `login-home` and `browse-play`. Deleting any of the three stems is red. The live spec opens PNL-02 on a locked episode and does not pay, invent Beans, enable recharge, or synthesise a BytePlus `vid`. GATE-2 / GATE-4 / GATE-8 stay unanswered. This is not folded into `pnpm verify`. This still does **not** close E-20 (granted unlock + resume) or protocol-C4 exit 1.
