...
| — | `POST /v1/unlock/ad-sessions` | live-only | C4-08 nonce. Doc 12 has no ad-unlock path |
| — | `POST /v1/unlock/ad-grants` | live-only | C4-08 redeem. `isEnded` is verified server-side. No ad-unit id on the wire |
