...
│   └── quality/                # G2.8 licenses, G1.5 coverage, G1.8 Gitleaks, G1.6 oasdiff, G2.4 Semgrep + CodeQL, G2.5 Trivy; not bundled
...
`check:sast`, `check:codeql`, `check:sca`) is a second workflow and is not folded into
