...
pnpm check:a11y            # QA-010; axe-core in jsdom; SCR-02 + SCR-03 + SCR-04 + SCR-05 + SCR-06 + SCR-07 + SCR-08 + search + SCR-12 + SCR-13 required; contrast < 4.5:1 fails; not TikTok WebView
