 ...
 *
 * The double is `progress/test-sessions.ts`'s rather than this file's own: C2 integration settled on
 * one viewer-resolution seam for the whole server (`docs/plan/cycle-2-integration.md` A1), and that
