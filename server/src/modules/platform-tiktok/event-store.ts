 ...
 * interface (the same file as unlock receipts, sessions, and coin unlock orders); a postgres URL
 * is refused rather than rewritten to a file. A restart that kept the receipt and lost the
 * idempotency claim would honour a redelivery as a new payment.
 */
