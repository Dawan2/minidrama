 ...
 * interface (the same file as unlock receipts, sessions, and watch progress); a postgres URL is
 * refused rather than rewritten to a file. A restart that kept the receipt and lost the
